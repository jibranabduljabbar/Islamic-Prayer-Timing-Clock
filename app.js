function PrayTimes(method) {
  ...
  */
      ...
      navigator.geolocation.getCurrentPosition(pos => {
        ...
        x = name
          .map((x, i) => {
           ...
           <li class="list-group-item d-flex justify-content-between align-items-center"> ${x}
           </li>
  ...
  `;
      ...
      return `<li class="list-group-item d-flex justify-content-between align-items-center"> ${x}`
